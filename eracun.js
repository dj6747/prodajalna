...
streznik.get('/', function(zahteva, odgovor) {
  if (zahteva.session.stranka && zahteva.session.stranka >= 0) {
      ...
      strankaIzRacuna(polja.seznamRacunov, function(napaka, stranka) {
        ...
        pesmiIzRacuna(racunId, function(pesmi) {
          if (!pesmi) {
            ...
            odgovor.send("<p>Na računu nimate nobene pesmi, \
...
streznik.get('/izpisiRacun/:oblika', function(zahteva, odgovor) {
  ...
  var strankaId = zahteva.session.stranka;
  
  vrniPodatkeStranka(strankaId, function(napaka, stranka) {
    stranka = stranka[0];
    pesmiIzKosarice(zahteva, function(pesmi) {
      if (!pesmi) {
        odgovor.sendStatus(500);
...
// Vrni stranke iz podatkovne baze
var vrniPodatkeStranka = function(strankaId, callback) {
